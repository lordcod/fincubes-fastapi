...
from app.services.admin_maintenance import MaintenanceOperationResult, clear_results
...
async def clear_results_endpoint(
    ...
    return await clear_results(competition_id=payload.competition_id, apply=payload.apply)
